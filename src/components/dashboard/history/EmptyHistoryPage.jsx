...
export default function EmptyHistoryPage() {
  ...
  return (
    <div className="h-full flex items-center justify-center flex-col mb-8">
      ...
      />
      <h2 className="text-xl sm:text-3xl font-semibold mb-2">No reports yet</h2>
      <p className="text-secondary_text text-center text-xs sm:text-sm">
        You havent upload or generated any reports yet. <br /> Get started by creating your first report.
      </p>
      <button
        onClick={() => {
        ...
        className="bg-secondary px-4 sm:px-6 py-2 rounded-md font-medium text-white text-xs sm:text-sm flex items-center justify-center gap-x-2 hover:bg-indigo-700 mt-5"
      >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-4 sm:w-6 fill-white">
