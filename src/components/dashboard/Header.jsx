  ...
  return (
    <div className="flex justify-center py-8">
      <div className="col-start-2 col-end-3 flex justify-between w-[1000px] items-center">
        ...
        <button onClick={() => setShowLogoutPopup(true)} className="flex gap-x-2 bg-white h-min px-4 py-2 rounded-lg text-sm items-center font-medium border shadow-[0_1px_3px_rgba(15,23,42,0.05),_0_8px_24px_rgba(15,23,42,0.04)] hover:bg-slate-50">
