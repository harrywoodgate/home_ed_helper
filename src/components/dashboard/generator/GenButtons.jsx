    ...
    <>
      <div className="flex flex-wrap w-full justify-end sm:justify-end gap-y-4 gap-x-2 sm:gap-x-4">
        ...
        >
          ...
          <span className="hidden sm:static">Preview</span>
        </button>
        <button
          onClick={() => {
        ...
        >
          ...
          <span className="hidden sm:static">Save</span>
        </button>
        <PDFDownloadLink
          document={document}
        ...
        >
          {({ loading }) => (
            <div className="flex items-center gap-2">
              ...
              <span className="hidden sm:static">{loading ? "Preparing..." : "Download"}</span>
            </div>
          )}
        </PDFDownloadLink>
        <button
        ...
        >
          ...
          <span className="hidden sm:static">New report</span>
        </button>
      </div>
    </>
  );
