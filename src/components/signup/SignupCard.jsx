  ...
  return (
    <div className="bg-white p-8 lg:p-12 flex flex-col items-center justify-center rounded-xl gap-y-2 lg:gap-y-4 w-full lg:w-[500px] border shadow-[0_1px_3px_rgba(15,23,42,0.05),_0_8px_24px_rgba(15,23,42,0.04)]">
      ...
      <div className="flex flex-col items-center mb-6">
        <h2 className="text-xl lg:text-2xl font-bold">Create your account</h2>
      ...
      <form onSubmit={handleSignup} className="flex flex-col gap-y-2 w-full">
        ...
        <button className="bg-secondary w-full rounded-lg py-2 lg:py-3 text-sm lg:text-base text-white mb-2 lg:mb-4">
          Create account
        </button>
      </form>
