...
export default function SingupBrandingCard() {
  return (
    <div className="flex flex-col justify-center h-screen lg:w-[338px]">
      ...
      <p className="text-xl lg:text-3xl font-bold mb-1">Simplify Learning,</p>
      <p className="text-xl lg:text-3xl font-bold mb-4">every day.</p>
      ...
      <div>
        <div className="flex gap-x-4 mt-6 items-center">
          ...
          <div>
            <p className="text-[10px] lg:text-xs font-bold mb-1">Save hours each week</p>
        ...
        <div className="flex gap-x-4 mt-6 items-center">
          <div className="bg-violet-200 rounded-full w-8 h-8 lg:w-10 lg:h-10 flex items-center justify-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              className="w-4 h-4 lg:w-6 lg:h-6 fill-secondary"
            >
        ...
        <div className="flex gap-x-4 mt-6 items-center">
          ...
          <div>
            <p className="text-[10px] lg:text-xs font-bold mb-1">Made for home educators</p>
            <p className="text-[10px] lg:text-xs text-secondary_text">
