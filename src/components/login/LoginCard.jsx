...
export default function LoginCard() {
  ...
  // make whole thing fit on screen better
  return (
    <div className="bg-white p-12 flex flex-col items-center justify-center rounded-xl gap-y-4 w-[500px] border shadow-[0_1px_3px_rgba(15,23,42,0.05),_0_8px_24px_rgba(15,23,42,0.04)]">
      ...
      <form onSubmit={handleLogin} className="flex flex-col gap-y-2 w-full">
        ...
        <button className="bg-secondary w-full rounded-md py-3 text-white relative mb-4">
          <span>Sign In</span>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-5 fill-white absolute right-3 bottom-3 pb-[2px]">
